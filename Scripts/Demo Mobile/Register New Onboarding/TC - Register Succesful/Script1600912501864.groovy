...
Mobile.delay(2)
Mobile.verifyElementExist(findTestObject('Object Repository/SiMobi/SignUp_Page/SIgnUp_ConfirmPinPage/ConfirmPIN_LabelText'), 2)
Mobile.tap(findTestObject('Object Repository/SiMobi/SignUp_Page/SIgnUp_ConfirmPinPage/ConfirmPIN_PINInputTextField'), 2)
...
while(counter < n){
	...
	num2 = num3
	counter = counter + 1;
	Mobile.tap(findTestObject('Object Repository/SiMobi/SignUp_Page/SIgnUp_ConfirmPinPage/ConfirmPIN_Keypad1', [('keypad') : num1]), 2)
}

Mobile.verifyElementExist(findTestObject('Object Repository/SiMobi/SignUp_Page/SignUp_MemberReferral/MemberReferral_LabelText'), 2)
Mobile.tap(findTestObject('Object Repository/SiMobi/SignUp_Page/SignUp_MemberReferral/MemberReferral_SKIPBtn'), 2)
Mobile.verifyElementExist(findTestObject('Object Repository/SiMobi/SignUp_Page/SignUp_MemberReferral/MemberReferral_PopUp_LabelText'), 2)
Mobile.tap(findTestObject('Object Repository/SiMobi/SignUp_Page/SignUp_MemberReferral/MemberReferral_PopUp_YesBtn'), 2)
Mobile.delay(5)

Mobile.verifyElementExist(findTestObject('Object Repository/SiMobi/Dashboard Page/DashboardPage_AccountNumberText'), 2)
